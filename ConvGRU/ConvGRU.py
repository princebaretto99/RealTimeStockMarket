...
# company = 'INFY'
# model = load_model('/content/cnnlstm.h5')
...
# from sklearn.metrics import mean_squared_error
# from math import sqrt
# rmse = sqrt(mean_squared_error(predict_x, predicted_stock_price))
# print(f"RMSE is : {rmse}")

# from sklearn.metrics import mean_absolute_error
# mae = mean_absolute_error(predict_x,predicted_stock_price)
# print(f"MAE is : {mae}")
